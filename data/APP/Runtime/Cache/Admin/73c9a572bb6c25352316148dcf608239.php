...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /> 
	<title>无标题</title>
<link rel="stylesheet" type="text/css" href="/thinkphp3.2.3/APP/Admin/View/public/css/admin.css">
</head>
<body>
<form method="post" action="<?php echo U('demo/index');?>">
<table  class="verify"> 
	<tr>
	...
	<tr>
		...
		<tr>
			<td colspan="2" align="center"><input type="submit" value="设置"/></td>
		</tr>
</table>
</form>
</body>
