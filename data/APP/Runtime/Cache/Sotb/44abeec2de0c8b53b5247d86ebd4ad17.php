...
<form id="form">
  <div class="list-block">
   ...
   <div class="row">
      <div class="col-50"><a href="<?php echo U('index/register');?>" class="button button-dark button-big" id="register">注 册</a></div>
      <div class="col-50"><a href="#" class="button button-success button-big" id="login">登  录</a></div>
    </div>
  </div>
  </div>
 </div>
