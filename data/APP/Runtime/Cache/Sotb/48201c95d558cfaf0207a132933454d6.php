...
<div class="page-group">
  <div class="page" id='admin'>
	  <header class="bar bar-nav">
	    <h1 class='title'><?php if($question['0']['audit'] == 1): ?>已审核的问题
          	<?php else: ?>
          	未审核的问题<?php endif; ?></h1>
	    ...
	    <a href="<?php echo U('adminsiyizcy/index','allow=1');?>" class="button button-link button-nav pull-left">
	      已审核的问题
	    </a>
	     <a href="<?php echo U('adminsiyizcy/index');?>" class="button button-link button-nav pull-left">
	      未审核的问题
	    </a>
	  </header>
<div class="content">
